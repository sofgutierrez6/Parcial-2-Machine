...
X_train, X_prueba, y_train_1, y_prueba_1 = train_test_split(datos, etiquetas_np, test_size=0.2, random_state=4)
X_test, X_val, y_test_1, y_val_1 = train_test_split(X_prueba, y_prueba_1, test_size=0.5, random_state=4)

des_train, des_prueba, y_train_2, y_prueba_2 = train_test_split(descriptores_norm, etiquetas_np, test_size=0.2, random_state=4)
